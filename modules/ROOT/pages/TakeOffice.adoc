...
|enum
|
|Значения: По умолчанию = 0, Письмо c описанием = 1, Задача Outlook = 2, Письмо со ссылкой на задание = 3, Офлайн задание = 4, Онлайн задание = 5, Зашифрованное офлайн = 6, Не маршрутизировать = 7, Особый = 8, Особый с оповещение по e-mail = 9
...
|enum
|
|Значения: Не маршрутизировать = 0, Письмо c описанием = 1, Задача Outlook = 2, Письмо со ссылкой на задание = 3, Офлайн задание = 4, Онлайн задание = 5, Зашифрованное офлайн = 6, Особый = 8, Особый с оповещением по e-mail = 9
