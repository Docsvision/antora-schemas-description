...
a|`IsDefault`
a|_Учётная запись по умолчанию_
a|`bool`
a|
a|

a|`ShowAccountDialog`
a|_Показывать диалог выбора учётной записи_
a|`bool`
a|
a|
...
Тип секции: `coll`
Название: _Дополнительные учётные записи_

.Поля секции Дополнительные учётные записи
|===
|Псевдоним |Название |Тип поля |Размер |Дополнительная информация 
...
a|`SysAccountName`
a|_Неизменяемая строка учётной записи_
a|`unistring`
a|1024
a|
